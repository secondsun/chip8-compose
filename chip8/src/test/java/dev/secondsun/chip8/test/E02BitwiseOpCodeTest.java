...
public class E02BitwiseOpCodeTest {
    ...
    public void testAndOpCodes() {
        ...
        Assertions.assertEquals(36, chip8.getV0());
        Assertions.assertEquals(0x27, chip8.getV1());

        chip8.execute(0x8232); // v2 = 0x12 & 0xAE
        Assertions.assertEquals(2, chip8.getV2());
        Assertions.assertEquals(0xAE, chip8.getV3());
    ...
    public void testOROpCodes() {
        ...
        Assertions.assertEquals(103, chip8.getV0());
        Assertions.assertEquals(0x27, chip8.getV1());

        chip8.execute(0x8231); // v2 = 0x12 | 0xAE
        Assertions.assertEquals(190, chip8.getV2());
        Assertions.assertEquals(0xAE, chip8.getV3());

        chip8.execute(0x8FE1); // 0x25 | 0x0
        Assertions.assertEquals(0x25, chip8.getVF());
    ...
    public void testXOROpCodes() {
        ...
        Assertions.assertEquals(67, chip8.getV0());
        Assertions.assertEquals(0x27, chip8.getV1());

        chip8.execute(0x8233); // v2 = 0x12 ^ 0xAE
        Assertions.assertEquals(188, chip8.getV2());
        Assertions.assertEquals(0xAE, chip8.getV3());
    ...
    public void testShiftRight() {
        ...
        Assertions.assertEquals(0x32, chip8.getV0());
        Assertions.assertEquals(0x0, chip8.getVF());

        chip8.execute(0x8236); // v2 = 0xAE >> 1; VF = 0x0
        Assertions.assertEquals(0x09, chip8.getV2());
        Assertions.assertEquals(0x0, chip8.getVF());

        chip8.execute(0x8446); // V4 = 0xFF >> 1; VF = 0x1;
        Assertions.assertEquals(127, chip8.getV4());
        Assertions.assertEquals(0x1, chip8.getVF());
    ...
    public void testShiftLeft() {
        ...
        Assertions.assertEquals(200, chip8.getV0());
        Assertions.assertEquals(0x0, chip8.getVF());

        chip8.execute(0x823E); // v2 = 0xAE << 1; VF = 0x0
        Assertions.assertEquals(36, chip8.getV2());
        Assertions.assertEquals(0x0, chip8.getVF());

        chip8.execute(0x844E); // V4 = 0xFF << 1; VF = 0x1;
        Assertions.assertEquals(254, chip8.getV4());
        Assertions.assertEquals(0x1, chip8.getVF());
    ...
    public void testRandom() {
        ...
        Assertions.assertEquals(230, chip8.getV1());

        chip8.execute(0xC23E); // v2 = 198 & 0x3E
        Assertions.assertEquals(6, chip8.getV2());

        chip8.execute(0xC44E); // V4 = 153 & 0x4E
        Assertions.assertEquals(8, chip8.getV4());
