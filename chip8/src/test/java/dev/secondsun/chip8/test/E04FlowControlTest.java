...
public class E04FlowControlTest {
    ...
    public void testJump() {
        ...
        Assertions.assertEquals(0xDAE, chip8.getPC());

        chip8.execute(0xB432);
        Assertions.assertEquals(1174, chip8.getPC());
    ...
    public void testSubroutines() {
        ...
        Assertions.assertEquals(0x200, chip8.getPC());
    ...
    public void testEqualJumps() {
       ...
       Assertions.assertEquals(0x202, chip8.getPC());//Increment the PC by 2
       
       chip8.execute(0x3164); // Skip if V1 == 0x64, doesn't skip because V1 == 0x27
       Assertions.assertEquals(0x202, chip8.getPC());//Do not increment the PC
       
       chip8.execute(0x6764); // Set V7 to 64
       chip8.execute(0x5070); // Skip if V0 == V7
       Assertions.assertEquals(0x204, chip8.getPC());//Increment the PC by 2
    ...
    public void testNonEqualJumps() {   
       ...
       Assertions.assertEquals(0x200, chip8.getPC());//Increment the PC by 2
