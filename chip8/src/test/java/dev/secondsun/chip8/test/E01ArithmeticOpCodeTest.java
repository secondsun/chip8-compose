...
public class E01ArithmeticOpCodeTest {
    ...
    public void testPCInitializedto0x200() {
        Assertions.assertEquals(0x0200, chip8.getPC());
    }
    ...
    public void testDataRegistersInitializedTo0() {
        Assertions.assertEquals(0x0, chip8.getV0());//Test initialized to 0
        Assertions.assertEquals(0x0, chip8.getV1());//Test initialized to 0
        Assertions.assertEquals(0x0, chip8.getV2());//Test initialized to 0
        Assertions.assertEquals(0x0, chip8.getV3());//Test initialized to 0
        Assertions.assertEquals(0x0, chip8.getV4());//Test initialized to 0
        Assertions.assertEquals(0x0, chip8.getV5());//Test initialized to 0
        Assertions.assertEquals(0x0, chip8.getV6());//Test initialized to 0
        Assertions.assertEquals(0x0, chip8.getV7());//Test initialized to 0
        Assertions.assertEquals(0x0, chip8.getV8());//Test initialized to 0
        Assertions.assertEquals(0x0, chip8.getV9());//Test initialized to 0
        Assertions.assertEquals(0x0, chip8.getVA());//Test initialized to 0
        Assertions.assertEquals(0x0, chip8.getVB());//Test initialized to 0
        Assertions.assertEquals(0x0, chip8.getVC());//Test initialized to 0
        Assertions.assertEquals(0x0, chip8.getVD());//Test initialized to 0
        Assertions.assertEquals(0x0, chip8.getVE());//Test initialized to 0
        Assertions.assertEquals(0x0, chip8.getVF());//Test initialized to 0
    }
    ...
    public void testLoadConstant() {
        ...
        Assertions.assertEquals(0x15, chip8.getV0());//Test loads 15 to V0

        chip8.execute(0x6120);
        Assertions.assertEquals(0x20, chip8.getV1());//etc

        chip8.execute(0x6225);
        Assertions.assertEquals(0x25, chip8.getV2());

        chip8.execute(0x6330);
        Assertions.assertEquals(0x30, chip8.getV3());

        chip8.execute(0x6435);
        Assertions.assertEquals(0x35, chip8.getV4());

        chip8.execute(0x6540);
        Assertions.assertEquals(0x40, chip8.getV5());

        chip8.execute(0x6645);
        Assertions.assertEquals(0x45, chip8.getV6());

        chip8.execute(0x6750);
        Assertions.assertEquals(0x50, chip8.getV7());

        chip8.execute(0x6855);
        Assertions.assertEquals(0x55, chip8.getV8());

        chip8.execute(0x6960);
        Assertions.assertEquals(0x60, chip8.getV9());

        chip8.execute(0x6A65);
        Assertions.assertEquals(0x65, chip8.getVA());

        chip8.execute(0x6B70);
        Assertions.assertEquals(0x70, chip8.getVB());

        chip8.execute(0x6C75);
        Assertions.assertEquals(0x75, chip8.getVC());

        chip8.execute(0x6D80);
        Assertions.assertEquals(0x80, chip8.getVD());

        chip8.execute(0x6E85);
        Assertions.assertEquals(0x85, chip8.getVE());

        chip8.execute(0x6F90);
        Assertions.assertEquals(0x90, chip8.getVF());
    }
    ...
    public void testAddConstant() {
        ...
        Assertions.assertEquals(0x2A, chip8.getV0());

        chip8.execute(0x6A42);
        chip8.execute(0x7A42);
        Assertions.assertEquals(0x84, chip8.getVA());//Test loads 15 to V0

        chip8.execute(0x6EFF);
        chip8.execute(0x7E01);
        Assertions.assertEquals(0x0, chip8.getVE());//Test Overflow
    ...
    public void testCopyRegister() {
        ...
        Assertions.assertEquals(0x42, chip8.getVA());
        Assertions.assertEquals(0x42, chip8.getVE());

        chip8.execute(0x6ADE);
        chip8.execute(0x8FA0);
        Assertions.assertEquals(0x42, chip8.getVE());
        Assertions.assertEquals(0xDE, chip8.getVF());
    ...
    public void testAddRegister() {
        ...
        Assertions.assertEquals(0x42, chip8.getVA());
        Assertions.assertEquals(0x84, chip8.getVE());
        Assertions.assertEquals(0x00, chip8.getVF());

        chip8.execute(0x6AF0);
        chip8.execute(0x6E42);
        chip8.execute(0x8FA0);
        chip8.execute(0x8EA4);
        Assertions.assertEquals(0xF0, chip8.getVA());
        Assertions.assertEquals(0x32, chip8.getVE());
        Assertions.assertEquals(0x01, chip8.getVF());
    ...
    public void testSubtractRegister() {
        ...
        Assertions.assertEquals(0x84, chip8.getVB());
        Assertions.assertEquals(161, chip8.getVD());
        Assertions.assertEquals(0x00, chip8.getVF());
        ...
        Assertions.assertEquals(0x84, chip8.getVB());
        Assertions.assertEquals(95, chip8.getVD());
        Assertions.assertEquals(0x01, chip8.getVF());
